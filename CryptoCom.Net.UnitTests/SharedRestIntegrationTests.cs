...
namespace CryptoCom.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private static SharedSymbol _futuresSymbol = new SharedSymbol(TradingMode.PerpetualLinear, "ETH", "USD");
        ...
        private ICryptoComRestClientExchangeApiShared GetRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddCryptoCom(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<ICryptoComRestClient>().ExchangeApi.SharedClient;
        }
        [Test]
